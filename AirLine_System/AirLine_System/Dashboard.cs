    ...
    public partial class Dashboard : Form
    {
        ...
        private void populateGrid()
        {
            ...
            else if (flag == "AIRLINE")
            {
                ...
                viewGrid.Columns[6].Visible = false;
                viewGrid.Columns[7].Visible = false;
                SqlCommand cmd = new SqlCommand("Select * from AIRPLINE", con);
                SqlDataAdapter adapter = new SqlDataAdapter(cmd);
                DataSet ds = new DataSet();
                adapter.Fill(ds);
            ...
            else if (flag == "FLIGHT")
            {
                ...
                viewGrid.Columns[4].HeaderText = "Departure_Date";
                viewGrid.Columns[5].HeaderText = "Arrival_Date";
                //viewGrid.Columns[6].HeaderText = "Departure_Date";
                //viewGrid.Columns[7].HeaderText = "Departure_Date";
        ...
        private void label7_Click(object sender, EventArgs e)
        {
            ...
            {
                new FormCompany().Show();
                this.Hide();
            }
            else if (flag == "AIRPLANE")
            {
                new FormAirplane().Show();
                this.Hide();
            }
            else if (flag == "FLIGHT")
            {
